...
<div class="slider-container">
    ...
    <div class="home-content">
        <ul class="slider">
            <li><img src="img/Phim/latmat8.jpg" alt=""><p>Lật Mặt 8</p><button>Xem Chi Tiết</button></li>
            <li><img src="img/Phim/thamtukien.jpg" alt=""><p>Thám Tử Kiên</p><button>Xem Chi Tiết</button></li>
